...
export const speciesEggMoves = {
  ...
  [SpeciesId.DROWZEE]: [ MoveId.TORCH_SONG, MoveId.STRENGTH_SAP, MoveId.LUMINA_CRASH, MoveId.SPARKLY_SWIRL ],
  ...
  [SpeciesId.CUBONE]: [ MoveId.HEAD_SMASH, MoveId.EARTHQUAKE, MoveId.FLAME_CHARGE, MoveId.BITTER_BLADE ],
  [SpeciesId.LICKITUNG]: [ MoveId.CRUSH_GRIP, MoveId.FIRE_LASH, MoveId.SLACK_OFF, MoveId.PRECIPICE_BLADES ],
  [SpeciesId.KOFFING]: [ MoveId.SCALD, MoveId.RECOVER, MoveId.MYSTICAL_POWER, MoveId.MALIGNANT_CHAIN ],
  [SpeciesId.RHYHORN]: [ MoveId.SHORE_UP, MoveId.FLAME_CHARGE, MoveId.ACCELEROCK, MoveId.HEAD_SMASH ],
  [SpeciesId.TANGELA]: [ MoveId.EARTH_POWER, MoveId.POWER_GEM, MoveId.JUNGLE_HEALING, MoveId.APPLE_ACID ],
  ...
  [SpeciesId.SCYTHER]: [ MoveId.MIGHTY_CLEAVE, MoveId.GEAR_GRIND, MoveId.TRAILBLAZE, MoveId.BITTER_BLADE ],
  ...
  [SpeciesId.EEVEE]: [ MoveId.POWER_TRIP, MoveId.NO_RETREAT, MoveId.AURA_SPHERE, MoveId.BOOMBURST ],
  ...
  [SpeciesId.SENTRET]: [ MoveId.CRUSH_GRIP, MoveId.FAKE_OUT, MoveId.COLLISION_COURSE, MoveId.NO_RETREAT ],
  [SpeciesId.HOOTHOOT]: [ MoveId.TAKE_HEART, MoveId.ESPER_WING, MoveId.AEROBLAST, MoveId.BOOMBURST ],
  [SpeciesId.LEDYBA]: [ MoveId.POLLEN_PUFF, MoveId.AEROBLAST, MoveId.AURA_SPHERE, MoveId.QUIVER_DANCE ],
  [SpeciesId.SPINARAK]: [ MoveId.AQUA_STEP, MoveId.ATTACK_ORDER, MoveId.GASTRO_ACID, MoveId.GUNK_SHOT ],
  [SpeciesId.CHINCHOU]: [ MoveId.THUNDERCLAP, MoveId.BOUNCY_BUBBLE, MoveId.FROST_BREATH, MoveId.TAIL_GLOW ],
  ...
  [SpeciesId.WOOPER]: [ MoveId.NOXIOUS_TORQUE, MoveId.RECOVER, MoveId.SHED_TAIL, MoveId.AQUA_STEP ],
  ...
  [SpeciesId.UNOWN]: [ MoveId.NO_RETREAT, MoveId.MOONGEIST_BEAM, MoveId.AURA_SPHERE, MoveId.MYSTICAL_POWER ],
  [SpeciesId.GIRAFARIG]: [ MoveId.MYSTICAL_POWER, MoveId.NIGHT_DAZE, MoveId.RECOVER, MoveId.BOOMBURST ],
  [SpeciesId.PINECO]: [ MoveId.METAL_BURST, MoveId.IRON_HEAD, MoveId.LEECH_LIFE, MoveId.SHELL_SMASH ],
  ...
  [SpeciesId.DELIBIRD]: [ MoveId.BONEMERANG, MoveId.FLOATY_FALL, MoveId.NO_RETREAT, MoveId.GLACIAL_LANCE ],
  ...
  [SpeciesId.MAGBY]: [ MoveId.QUIVER_DANCE, MoveId.EARTH_POWER, MoveId.ENERGY_BALL, MoveId.BLUE_FLARE ],
  ...
  [SpeciesId.POOCHYENA]: [ MoveId.KNOCK_OFF, MoveId.PLAY_ROUGH, MoveId.IRON_HEAD, MoveId.VICTORY_DANCE ],
  [SpeciesId.ZIGZAGOON]: [ MoveId.EXTREME_SPEED, MoveId.KOWTOW_CLEAVE, MoveId.HIGH_HORSEPOWER, MoveId.SWORDS_DANCE ],
  [SpeciesId.WURMPLE]: [ MoveId.FIERY_DANCE, MoveId.QUIVER_DANCE, MoveId.STORED_POWER, MoveId.MALIGNANT_CHAIN ],
  [SpeciesId.LOTAD]: [ MoveId.REVELATION_DANCE, MoveId.APPLE_ACID, MoveId.ICE_BEAM, MoveId.NASTY_PLOT ],
  ...
  [SpeciesId.MUNCHLAX]: [ MoveId.OBSTRUCT, MoveId.AQUA_STEP, MoveId.SUCKER_PUNCH, MoveId.SLACK_OFF ],
  ...
  [SpeciesId.GALAR_SLOWPOKE]: [ MoveId.SLUDGE_WAVE, MoveId.BADDY_BAD, MoveId.STORED_POWER, MoveId.SHELL_SMASH ],
  [SpeciesId.GALAR_FARFETCHD]: [ MoveId.ROOST, MoveId.SACRED_SWORD, MoveId.AGILITY, MoveId.BEHEMOTH_BLADE ],
